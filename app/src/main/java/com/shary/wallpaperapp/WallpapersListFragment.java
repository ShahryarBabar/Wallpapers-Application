...
public class WallpapersListFragment extends Fragment implements WallpaperSelectListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView wallpaperRecyclerView = view.findViewById(R.id.fragment_listwallpapers_recyclerView);
        ...
        wallpapers.add(new Wallpaper("SeaWave", "https://images.pexels.com/photos/1716499/pexels-photo-1716499.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260"));
        wallpapers.add(new Wallpaper("Abstract", "https://images.pexels.com/photos/2801090/pexels-photo-2801090.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"));
        wallpapers.add(new Wallpaper("Bridge", "https://images.pexels.com/photos/3603183/pexels-photo-3603183.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"));
        wallpapers.add(new Wallpaper("Hills", "https://images.pexels.com/photos/5161632/pexels-photo-5161632.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"));
        wallpapers.add(new Wallpaper("Pink", "https://images.pexels.com/photos/2234783/pexels-photo-2234783.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"));


        wallpaperGalleryRecyclerAdapter = new WallpaperGalleryRecyclerAdapter(this , wallpapers);
        wallpaperRecyclerView.setAdapter(wallpaperGalleryRecyclerAdapter);
        wallpaperGalleryRecyclerAdapter.notifyDataSetChanged();
